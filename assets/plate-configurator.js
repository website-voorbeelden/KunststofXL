(function(){
  ...
  function init(root){
    ...
    function draw(){
      ...
      dimW.setAttribute('x1',x);dimW.setAttribute('x2',x+rw);dimW.setAttribute('y1',y+rh+32);dimW.setAttribute('y2',y+rh+32);labelW.setAttribute('x',320);labelW.setAttribute('y',y+rh+52);labelW.textContent=w+' mm';
      dimH.setAttribute('x1',x-30);dimH.setAttribute('x2',x-30);dimH.setAttribute('y1',y);dimH.setAttribute('y2',y+rh);labelH.setAttribute('x',x-40);labelH.setAttribute('y',170);labelH.textContent=h+' mm';
